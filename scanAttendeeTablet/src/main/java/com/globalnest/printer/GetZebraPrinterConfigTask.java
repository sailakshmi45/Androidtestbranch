...
public class GetZebraPrinterConfigTask extends AsyncTask<String,Void,String> {
                            ...
                            try {
                               ...
                               setImageHeightWidth();
                                ...
                                if(ext_settings!=null && ext_settings.zebra_settings){
                                    ...
                                    AppUtils.displayLog("----","Double Width-"+zebrabadgePrintWidth+"|"+"Length-"+zebrabadgeLabelLength);
                                    ...
                                    AppUtils.displayLog("----","Width-"+zebraPrintWidth+"|"+"Length-"+zebraLabelLength);
    ...
    private void setImageHeightWidth() {
        ...
        if (badge_res.size() > 0) {
            AppUtils.displayLog("Resolution value---",String.valueOf(PrinterDetails.selectedPrinterPrefrences.getString(ZebraPrinter.ZEBRA_RESOLUTION, "")));
