...
public class LoginActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		try {
			...
			/*if (spinPosition == 0) {
				emaidIDD = login_user_details_pref.getString(AppUtils.PRO_USER_EMAIL_ID, "");
			} else if (spinPosition == 1) {
				emaidIDD = login_user_details_pref.getString(AppUtils.QA_USER_EMAIL_ID, "");
			} else if (spinPosition == 2) {
				emaidIDD = login_user_details_pref.getString(AppUtils.DEV_USER_EMAIL_ID, "");
			} else {
				emaidIDD = login_user_details_pref.getString(AppUtils.PRO_USER_EMAIL_ID, "");
			}*/
