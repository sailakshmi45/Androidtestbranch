...
public class DBFeilds  {
    ...
    public static final String TABLE_REGFORMATTENDEEDETAILS = "RegFormAttendeeDetails";
    ...
    public static final String TABLE_DEFAULTCOUNTRYS = "DefaultCountrys";
    ...
    public static final String TABLE_DASHBOARDCOUNTS = "Dashboardcounts";
    public static final String TABLE_HIDEITEMS = "HideItems";
    public static final String TABLE_GLOBALPICKLISTVALUES = "GlobalPicklistValues";
    public static final String TABLE_REGISTRATIONQUESTIONS = "RegistrationQuestions";
    public static final String TABLE_REGISTRATIONANSWERS = "RegistrationAnswers";
    public static final String TABLE_ATTENDEEMULTIPICKLISTVALUES = "AttendeeMultiPicklistValues";
    ...
    public static final String USER_ispastservicecalled = "ispastservicecalled";
    // State table fields
    ...
    public static final String COUNTRY_EVENTID = "event_id";
    public static final String COUNTRY_NUMBER = "CountryNo";
    public static final String COUNTRY_ISDEFAULT = "IsDefault__c"; // Event table fields
    ...
    public static final String EVENT_REAL_TIME_CHECKIN = "Real_Time_Checkin__c";
    public static final String EVENT_isbadgeservicecalled = "isbadgeservicecalled";
...
//
   /* CreatedDate="",credit_card_last_4digits__c="",credit_card_type__c="",Currency_Code__c="",Id="",
    ...
    public static final String ATTENDEE_TKTPROFILEID = "Tktprofile_Id";
    ...
    public static final String ATTENDEE_EXCEPTIONALKEYWORDS="Exceptional_Keywords";
    ...
    public static final String ATTENDEE_SPEAKERFACEBOOKID="SpeakerFaceBookId";
    public static final String ATTENDEE_NUMBER_1__C="Number_1__c";
    public static final String ATTENDEE_NUMBER_2__C="Number_2__c";
    public static final String ATTENDEE_NUMBER_3__C="Number_3__c";
    public static final String ATTENDEE_NUMBER_4__C="Number_4__c";
    public static final String ATTENDEE_NUMBER_5__C="Number_5__c";
    public static final String ATTENDEE_TEXT_1__C="Text_1__c";
    public static final String ATTENDEE_TEXT_2__C="Text_2__c";
    public static final String ATTENDEE_TEXT_3__C="Text_3__c";
    public static final String ATTENDEE_TEXT_4__C="Text_4__c";
    public static final String ATTENDEE_TEXT_5__C="Text_5__c";
    ...
    public static final String ATTENDEE_NAICS="NAICS";
    public static final String ATTENDEE_COMMODITIES="Commodities";
    public static final String ATTENDEE_SUBCOMMODITIES="SubCommodities";
    public static final String ATTENDEE_DIVERSITIES="Diversities";
    ...
    public static final String ATTENDEE_VERIFY_EMAIL = "verify_email__c";
    ...
    public static final String ATTENDEE_TAG = "Tag_No__c";
    public static final String ATTENDEE_NOTE = "note";
    // public static final String ATTENDEE_DESIGNATION = "designation";
    public static final String ATTENDEE_BADGE_LABLE = "Badge_Label__c";
...
//Old Attendee Table
   /* public static final String ATTENDEE_ID = "Attendee_Id";
    ...
    public static final String BADGE_DOUBLE_SIDED_BADGE__C="Double_sided_badge__c";
    public static final String BADGE_DOUBLE_SIDED_BADGE_OPTION__C="Double_sided_badge_Option__c";
    ...
    public static final String LAYER_IMAGE_STATIC = "image_static";
    ...
    //Dashboardcounts Table
    public static final String EVENT_ID = "Event_id";
    public static final String GROUPID = "groupid";
    public static final String TOTALCHECKINCOUNT = "totalcheckincount";
    ...
    public static final String ANSWER_DEFAULT = "Answer_Default";
    public static final String ANSWER_ORDER = "Answer_Order";

   // public static final String Question_Text = "Question_Text";

//table_images_columns

    public static final String IMAGE_NAME = "image_name";
    public static final String IMAGE_ID = "image_id";
    public static final String IMAGE_BYTE = "image_byte";
    public static final String IMAGE_EVENTID= "Eventid";
