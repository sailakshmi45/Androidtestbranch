...
package com.globalnest.swipelistview;
...
public class SwipeListViewTouchListener implements View.OnTouchListener {
    ...
    private int lastOpenedPosition =0;
    /**
     * Constructor
     *
    ...
    protected void closeAnimate(int position) {
        ...
        closeAnimate(swipeListView.getChildAt(position - swipeListView.getFirstVisiblePosition()).findViewById(swipeFrontView), position);
    		...
    		closeAnimate(swipeListView.getAdapter().getView(position, null, null),position);
    }
     ...
     * @param position Position of list
     */
    public void closeAnimate(View view, int position) {
