			...
			back_layout.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					if(Util.getselfcheckinbools(Util.ISSELFCHECKIN)){
						...
						c_order_info_intent = new Intent(SearchAttendeeActivity.this,CollectOrderInfok.class);
					}
					...
					c_order_info_intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
					//c_order_info_intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
			...
			searchAttendee.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> _adapter, View view, int position,
					...
					if(Util.getselfcheckinbools(Util.ISSELFCHECKIN)){
						...
						//	Util.db.copyData(c1.getString(c1.getColumnIndex(DBFeilds.ATTENDEE_ID)));
						c_order_info_intent = new Intent(SearchAttendeeActivity.this,CollectOrderInfok.class);
					}
					//Intent c_order_info_intent = new Intent(SearchAttendeeActivity.this,CollectOrderInfok.class);
