    ...
    private void encodeQRCodeContents(String data, Bundle bundle, String type) {
        if (type.equals(Contents.Type.TEXT)) {
            ...
            if (data != null) {
                ...
                String address = trim(temp[4]+","+temp[5]);
                if (address != null) {
                ...
                String company = temp[6];   
                newContents.append("ORG:").append(escapeMECARD(company)).append(';');
                newDisplayContents.append('\n').append(company);
...
//                }
    ...
    public Bitmap encodeAsBitmap(String contents, BarcodeFormat format, int img_width, int img_height) throws WriterException {
        ...
        private static String guessAppropriateEncodingNew(CharSequence contents) {
        // Very crude at the moment
        for (int i = 0; i < contents.length(); i++) {
